...
async def word_screen_capture(filename: str | None = None, output_path: str | None = None) -> str:
    ...
    """
    if _MAC_AVAILABLE:
        from word_mcp_codemode_live.core.word_mac import mac_screen_capture
    ...
    try:
        ...
        if not output_path:
            temp_dir = os.path.join(os.environ.get("TEMP", "/tmp"), "word_mcp_captures")
